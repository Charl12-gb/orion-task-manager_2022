 ...
 * @subpackage Orion_Task_Manager/admin
 */
 ...
 */
class Orion_Task_Manager_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'bootstrap4', 'https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/js/bootstrap-select.min.js', array( 'jquery' ), $this->version, false );
