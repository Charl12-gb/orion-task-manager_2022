...
class Task_Manager_Builder
{
    ...
    public static function settings_page()
    {
        ...
        <?php
        } else include_once('configuration-first-active.php');
    }
        ...
        if (isset($_POST['verify_plugin_first_parameter'])) {
            if (wp_verify_nonce($_POST['verify_plugin_first_parameter'], 'plugin_first_parameter')) {
                ...
                $task_page = array(
                    ...
                    'post_content'  => '<!-- wp:paragraph --> <p>[orion_task]</p> <!-- /wp:paragraph -->',
                    'post_status'   => 'publish',
                ...
                $evaluation_page = array(
                    ...
                    'post_content'  => '<!-- wp:paragraph --><p>[task_evaluation]</p><!-- /wp:paragraph -->',
                    'post_status'   => 'publish',
    ...
    public static function parameterSendTimeReport()
    {
        ...
        if (isset($_POST['all_sync'])) {
            ...
            if ($_POST['all_sync'] == 'project') {
                ...
                if ($output2 == 'projet') echo true;
                else echo false;
            }
            if ($_POST['all_sync'] == 'objective') {
                $output3 = sync_objectives_month();
                if ($output3 == 'objectif') echo true;
                else echo false;
            }
            if ($_POST['all_sync'] == 'task') {
                $output4 = sync_tasks();
                if ($output4 == 'task') echo true;
                else echo false;
            }
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div id="card_warning">
                                                    ...
                                                    <h6 class="pl-4"><input type="checkbox" disabled>Tasks and sub-tasks</h6>
                                                    <hr>
                                                    <h6>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="user_calendar" <?php if (is_project_manager() == null) echo 'readonly'; ?> name="user_calendar" class="form-control user_calendar">
                                    <?php if (is_project_manager() != null) { ?> <option value="">Everyone</option><?= option_select(get_all_users('name')) ?>
                                    <?php } else { ?><option selected><?= get_userdata(get_current_user_id())->display_name ?></option> <?php } ?>
                                </select>
                            </div>
